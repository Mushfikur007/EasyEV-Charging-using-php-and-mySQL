...
// Get full locations
$full_locations = $location->getFullLocations();

// Generate HTML output
ob_start();
?>
<div class="row">
    <?php if($full_locations->num_rows > 0): ?>
        <?php while($row = $full_locations->fetch_assoc()): ?>
    ...
    <?php else: ?>
        <div class="col-12">
            <div class="alert alert-info">
                ...
                No full charging stations at the moment.
            </div>
        </div>
    <?php endif; ?>
</div>
